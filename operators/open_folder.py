...
@class_to_register
class RENDERGATE_OT_open_folder(Operator):
    bl_idname: str = "rendergate.open_folder"
    bl_label: str = "Open Download Folder"
    bl_description: str = (
    ...
    def execute(self, context: Context):
        ...
        try:
            if sys.platform == "win32":
                ...
                self.report(
                    {"WARNING"},
                    f"Opening file browser on {sys.platform} not supported.",
                )
